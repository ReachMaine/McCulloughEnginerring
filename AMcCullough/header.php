...
<?php /* mods
* 13July16 zig
*		- add GTM function call
* 		- remove the "define your main nav" text (no main nav, one page)
*		- remove mobile menu (one page site)
*/ ?>
		...
		<header id="masthead" class="site-header" role="banner">
			<div class="row"> 
				<div class="large-12 columns header-container">
					<?php /* <div class="mobile-menu show-for-small">
					...
					<div class="left-links">
						<?php if(!isset($flatsome_opt['nav_position']) || $flatsome_opt['nav_position'] == 'top'){ ?>
							<ul id="site-navigation" class="header-nav">
		                        ...
		                        <?php else: ?>
		                            <?php /* zig xout <li>Define your main navigation in <b>Appearance > Menus</b></li> */ ?>
		                        <?php endif; ?>								
							</ul>
